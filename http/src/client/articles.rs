...
use viendesu_protocol::requests::articles::{create, delete, edit, get, search};

use crate::requests::articles as requests;

impl Articles for HttpClient {
    ...
    fn search(&mut self) -> impl CallStep<search::Args, Ok = search::Ok, Err = search::Err> {
        self.do_call(Method::GET, todo::<_, requests::Search>())
    }
